...
export const messages: Record<Locale, Messages> = {
  en: {
    ...
    setup: {
      title: 'Key setup',
      subtitle: 'Enter your AI API key to start coaching. Voice is already configured.',
      mistralLabel: 'AI API key',
      elevenLabel: 'ElevenLabs Voice',
      elevenPreConfigured: 'Pre-configured and ready',
      mistralHint: 'Paste your API key here',
      elevenHint: '',
      testKeys: 'Test key',
      testing: 'Testing…',
    ...
    common: {
      missingKeys: 'AI key not set. Please go to setup.',
      locale: 'Language',
    },
  },
  es: {
    ...
    setup: {
      title: 'Configuración',
      subtitle: 'Ingresa tu clave API de IA para comenzar. La voz ya está configurada.',
      mistralLabel: 'Clave API de IA',
      elevenLabel: 'Voz ElevenLabs',
      elevenPreConfigured: 'Pre-configurada y lista',
      mistralHint: 'Pega tu clave API aquí',
      elevenHint: '',
      testKeys: 'Probar clave',
      testing: 'Probando…',
      saveAndContinue: 'Guardar y entrenar',
      success: 'La clave API es válida.',
    ...
    common: {
      missingKeys: 'Falta la clave API. Ve a configuración.',
      locale: 'Idioma',
    },
  },
  fr: {
    ...
    setup: {
      title: 'Configuration',
      subtitle: "Entrez votre clé API IA pour commencer. La voix est déjà configurée.",
      mistralLabel: 'Clé API IA',
      elevenLabel: 'Voix ElevenLabs',
      elevenPreConfigured: 'Pré-configurée et prête',
      mistralHint: 'Collez votre clé API ici',
      elevenHint: '',
    ...
    common: {
      missingKeys: 'Clé API manquante. Allez à la configuration.',
      locale: 'Langue',
    },
  },
};
