...
export const messages: Record<Locale, Messages> = {
  en: {
    ...
    setup: {
      ...
      mistralHint: 'Starts with sk-',
      elevenHint: 'Looks like a long token',
      testKeys: 'Test keys',
      testing: 'Testing…',
  ...
  es: {
    ...
    setup: {
      ...
      mistralHint: 'Empieza con sk-',
      elevenHint: 'Parece un token largo',
  ...
  fr: {
    ...
    setup: {
      ...
      mistralHint: 'Commence par sk-',
      elevenHint: 'Ressemble à un long token',
